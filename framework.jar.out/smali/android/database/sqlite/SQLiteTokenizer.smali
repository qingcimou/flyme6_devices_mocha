...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/database/sqlite/SQLiteTokenizer$-java_util_List_tokenize_java_lang_String_sql_int_options_LambdaImpl0;
    }
.end annotation
...
# direct methods
.method static synthetic -android_database_sqlite_SQLiteTokenizer-mthref-0(Ljava/util/ArrayList;Ljava/lang/String;)V
    .locals 0
...
.method public static isFunction(Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "coalesce"
...
.method public static isKeyword(Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "CONSTRAINT"
    ...
    const-string/jumbo v1, "CURRENT_DATE"
    ...
    const-string/jumbo v1, "DEFERRABLE"
    ...
    const-string/jumbo v1, "INITIALLY"
    ...
    const-string/jumbo v1, "SAVEPOINT"
...
.method public static isType(Ljava/lang/String;)Z
    ...
    const-string/jumbo v1, "MEDIUMINT"
    ...
    const-string/jumbo v1, "NVARCHAR"
...
.method public static tokenize(Ljava/lang/String;I)Ljava/util/List;
    ...
    new-instance v1, Landroid/database/sqlite/SQLiteTokenizer$-java_util_List_tokenize_java_lang_String_sql_int_options_LambdaImpl0;

    invoke-direct {v1, v0}, Landroid/database/sqlite/SQLiteTokenizer$-java_util_List_tokenize_java_lang_String_sql_int_options_LambdaImpl0;-><init>(Ljava/util/ArrayList;)V
...
.method public static tokenize(Ljava/lang/String;ILjava/util/function/Consumer;)V
    ...
    .line 99
    .local v0, "ch":C
    invoke-static {v0}, Landroid/database/sqlite/SQLiteTokenizer;->isAlpha(C)Z
    ...
    invoke-static {v9}, Landroid/database/sqlite/SQLiteTokenizer;->isAlNum(C)Z
    ...
    invoke-static {v0, v9}, Landroid/database/sqlite/SQLiteTokenizer;->isAnyOf(CLjava/lang/String;)Z
    ...
    .line 121
    const-string/jumbo v9, "Unterminated quote"

    invoke-static {v9, p0}, Landroid/database/sqlite/SQLiteTokenizer;->genException(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/IllegalArgumentException;
    ...
    invoke-static {p0, v9}, Landroid/database/sqlite/SQLiteTokenizer;->peek(Ljava/lang/String;I)C
    ...
    .line 139
    .local v8, "tokenUnquoted":Ljava/lang/String;
    ...
    .end local v7    # "token":Ljava/lang/String;
    .end local v8    # "tokenUnquoted":Ljava/lang/String;
    :cond_5
    ...
    .restart local v8    # "tokenUnquoted":Ljava/lang/String;
    :cond_6
    move-object v7, v8
    ...
    .line 148
    const-string/jumbo v9, "Non-token detected"
    ...
    .line 180
    const-string/jumbo v9, "Unterminated comment"
    ...
    .line 199
    const-string/jumbo v9, "Semicolon is not allowed"
