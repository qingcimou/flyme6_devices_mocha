...
.method private reloadGpsProperties(Landroid/content/Context;Ljava/util/Properties;)V
    ...
    .line 624
    .local v7, "isPropertiesLoadedFromFile":Z
    const-string/jumbo v12, "ro.hardware.gps"
    ...
    .line 626
    .local v6, "gpsHardware":Ljava/lang/String;
    ...
    const-string/jumbo v13, "/etc/gps."
    ...
    .line 630
    .local v10, "propFilename":Ljava/lang/String;
    move-object/from16 v0, p2

    invoke-direct {p0, v10, v0}, Lcom/android/server/location/GnssLocationProvider;->loadPropertiesFromFile(Ljava/lang/String;Ljava/util/Properties;)Z

    move-result v7

    .line 632
    .end local v7    # "isPropertiesLoadedFromFile":Z
    .end local v10    # "propFilename":Ljava/lang/String;
    :cond_1
    if-nez v7, :cond_2

    .line 633
    const-string/jumbo v12, "/etc/gps.conf"
    ...
    const-string/jumbo v14, "GPS properties reloaded, size = "
    ...
    .line 637
    .local v8, "lpp_prof":Ljava/lang/String;
    ...
    invoke-virtual {v0, v12, v8}, Ljava/util/Properties;->setProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1, v12}, Ljava/util/Properties;->store(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    invoke-static {v12}, Lcom/android/server/location/GnssLocationProvider;->native_configuration_update(Ljava/lang/String;)V
    ...
    const-string/jumbo v14, "final config = "
    ...
    :cond_7
    :goto_3
    const-string/jumbo v12, "ES_EXTENSION_SEC"
    ...
    .line 684
    .local v3, "emergencyExtensionSeconds":I
    iget-object v12, p0, Lcom/android/server/location/GnssLocationProvider;->mNIHandler:Lcom/android/internal/location/GpsNetInitiatedHandler;

    invoke-virtual {v12, v3}, Lcom/android/internal/location/GpsNetInitiatedHandler;->setEmergencyExtensionSeconds(I)V
    :try_end_3
    .catch Ljava/lang/NumberFormatException; {:try_start_3 .. :try_end_3} :catch_3

    .line 619
    .end local v3    # "emergencyExtensionSeconds":I
    :goto_4
    return-void

    .line 649
    .end local v4    # "emergencyExtensionSecondsString":Ljava/lang/String;
    .end local v11    # "suplESProperty":Ljava/lang/String;
    :catch_0
    move-exception v2
    ...
    const-string/jumbo v13, "failed to dump properties contents"
    ...
    .line 673
    .restart local v11    # "suplESProperty":Ljava/lang/String;
    :cond_9
    const/4 v12, 0x0
    ...
    .line 685
    .end local v2    # "e":Ljava/lang/NumberFormatException;
    .restart local v4    # "emergencyExtensionSecondsString":Ljava/lang/String;
    :catch_3
    move-exception v2
    ...
    const-string/jumbo v14, "unable to parse ES_EXTENSION_SEC: "
